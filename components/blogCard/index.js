...
const BlogCard = () => {
    return (
        <>
            <li className="border-b border-b-borderGray pb-10 cursor-pointer mb-10 blog-card">
                <div className='flex items-center justify-between'>
                    <div className='max-w-3xl'>
                        <b className='text-2xl font-bold'>MongoDB and Vercel: from idea to global fullstack app in seconds</b>
                        <div className='opacity-50'><small>16 Jun, 2020 | 4 min read | 23K views</small></div>
                        <p className='mt-5'>Lets build a desktop app with Deno. Yes. A desktop app. No Electron. Actually, lets make it harder on ourselves! lets make a 3D desktop app! Will it be a GOOD desktop app? Of course not! Whose blo…</p>
                    </div>
